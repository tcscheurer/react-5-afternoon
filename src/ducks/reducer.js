...
// Type(s) declaration
const UPDATE_LOAN = "UPDATE_LOAN_TYPE",
      UPDATE_PROP_TYPE = "UPDATE_PROPERTY_TYPE",
      ...
      UPDATE_ADDRESS_THREE = "UPDATE_ADRESS_THREE",
...
export function updateLoanType(loanType){
    return {type: UPDATE_LOAN, payload: loanType }
}

export function updatePropType(property){
    return {type: UPDATE_PROP_TYPE, payload: property }
}
...
export function updateRealEstateAgent(agent){
    return {type: UPDATE_REAL_ESTATE_AGENT, payload: agent}
}
