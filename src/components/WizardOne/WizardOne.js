...
import {updateLoanType, updatePropType} from '../../ducks/reducer';

class WizardOne extends Component {
    render(){

        const {updateLoanType,updatePropType} = this.props;
        return(
            <div className="parent-div">
                <div className="vert-align">
                    ...
                    <select onChange={e=>updatePropType(e.target.value)}>
...
export default connect(mapStateToProps,{updateLoanType, updatePropType}) (WizardOne); 